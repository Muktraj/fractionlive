...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('.header__logo').find('img').attr( {src:'assets/images/logo/logo.png',width:'80',height:'30'} );
              $('.logo_footer').find('img').attr( {src:'assets/images/logo/logo.png',width:'80',height:'44'} );
            }   
      };
